...
days = 30
print("total days in a 1 month: ",days)
holidays = 4
print("Holidays in a 1 month: ",holidays)
total_working_days = days - holidays
print("Total working days: ",total_working_days)
salary_per_hour = 100
print("Salary per hours: ",salary_per_hour)
working_hours = 8 
print("Total working hours in a day: ",working_hours)
real_working_hours = working_hours-2
print("Real time working hours: ",real_working_hours)
expect_work_month = total_working_days * working_hours
print("Expect working hours in one month: ",expect_work_month)
real_work_month = total_working_days * real_working_hours
print("Exact working hours in one month: ",real_work_month)
salary_month = salary_per_hour * real_work_month
print("Employees 1 Month salary is: ",salary_month)
